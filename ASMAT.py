...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mWELL COME TO ASMAT KHAN \033[1;35m• \033[1;36m• \033[1;34m•')
...
\t\x1b[1;97m ¦¦   ¦¦ ¦¦¦¦¦¦¦ ¦¦      ¦¦ ¦¦   ¦¦    ¦¦    
\x1b[1;97m --------------------------------------------------
 SCRIPT OWNER ASMAT KHAN
\x1b[1;97m WHATSAPP : 03402135201
\x1b[1;97m--------------------------------------------------
\x1b[1;97m 𝐀𝐒𝐌𝐀𝐓 𝐈𝐒 𝐍𝐎𝐓 𝐍𝐀𝐌𝐄 𝐈𝐓𝐒 𝐁𝐑𝐀𝐍𝐃
\x1b[1;97m--------------------------------------------------
...
def menu(my_name,my_id):
	...
	print('')
	print("%s------------------------------------------%s"%(B,P))
	print(f'[{H}v{P}] [%s01%s] PUBLIC ID CRACKER   [%sON%s]'%(K,N,B,N));time.sleep(0.03)
	print(f'[{H}v{P}] [%s02%s] MORE THEN ONE CRACKER   [%sON%s]'%(K,N,B,N));time.sleep(0.03)
	print(f'[{H}v{P}] [%s03%s] FILE CRACKER     [%sON%s]'%(K,N,B,N));time.sleep(0.03)
	print(f'[{H}v{P}] [%s00%s] Logout (%sCookie%s)'%(M,N,M,N));time.sleep(0.03)
	print("%s------------------------------------------%s"%(B,P))
