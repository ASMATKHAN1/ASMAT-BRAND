...
def menu(my_name,my_id):
	...
	print('')
	print("%s------------------------------------------%s"%(B,P))
	print(f'[{H}v{P}] [%s1%s] PUBLIC ID CRACKER   [%sON%s]'%(K,N,B,N));time.sleep(0.03)
	print(f'[{H}v{P}] [%s2%s] MORE THEN ONE CRACKER   [%sON%s]'%(K,N,B,N));time.sleep(0.03)
	print(f'[{H}v{P}] [%s3%s] FILE CRACKER     [%sON%s]'%(K,N,B,N));time.sleep(0.03)
